ENCODINGS: tuple = ('ascii', 'big5', 'big5hkscs', 'cp037', 'cp273', 'cp424', 'cp437', 'cp500', 'cp720', 'cp737',
...
FIGURE_PROPERTIES: tuple = ('xlabel', 'ylabel', 'grid', 'legend', 'title')
GRAPH_PROPERTIES: tuple = ('alpha', 'color', 'c', 'label', 'linestyle', 'ls', 'linewidth', 'lw')
FILE_PROPERTIES: tuple = ('delimiter', 'dpi', 'index', 'MultipleOutput', 'OutputPath', 'save')
