...
---
Функция ***create_graph*** принимает одни обязательный параметр
***data_file*** и 2 необязательных параметра ***properties_file*** и 
***encoding***. Параметр ***data_file*** - путь к ***csv*** файлу,
содержащему данные необходимы для построения графика/графиков,
параметр ***properties_file*** - путь к ***json*** файлу, содержащему
параметры построения и сохранения графика/графиков, параметр
...
|          index           |    int     | Обязательный параметр |                                [1;-]                                 |       Индекс графика        |
